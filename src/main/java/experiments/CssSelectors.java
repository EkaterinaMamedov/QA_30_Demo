...
public class CssSelectors {
    ...
    public void selectorsHomePage() {
        ...
        driver.manage().window().maximize();//контроль окна через менеджер и его размера
        ...
        System.out.println("TagName elements-->" + imgTools.getTagName());
       ...
       // WebElement radioButtonYes2 = driver.findElement(By.xpath("//label[@for='yesRadio']"));
        ...
        pause(4000);
        // driver.close();//одно окно
        driver.quit();//закрывает браузер

//document.querySelector('#fixedban').style.display='none' что бы банер не запускался
